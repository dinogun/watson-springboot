...
echo "#################### Run the App #####################"
prep_image_id=$(docker run --privileged -d watson-springboot:openj9-v8.criu-prep)
echo
...
test_cont=$(docker run --privileged -d -p 8080:8080 watson-springboot:openj9-v8.criu-checkpoint)
